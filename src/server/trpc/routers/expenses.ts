  ...
  update: groupMemberProcedure
    .input(
      z.object({
        ...
        subtotal: z.number().int().nonnegative().nullable().optional(),
        serviceCharge: z.number().int().nonnegative().nullable().optional(),
        tax: z.number().int().nonnegative().nullable().optional(),
        discount: z.number().int().nonnegative().nullable().optional(),
        rounding: z.number().int().nullable().optional(),
        category: z.string().max(50).optional(),
        expenseDate: z.string().datetime().optional(),
